        ...
        <section ref={ref} className="min-h-screen md:h-[110vh] flex items-center justify-center sticky top-0 bg-background py-10 md:py-0">
            ...
            >
                <Image
                    ...
                    alt={service.title}
                    fill
                    className="object-cover brightness-[0.3] md:brightness-[0.4]"
                />
                    ...
                    <motion.div style={{ y }} className="w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10 items-end">
                            <div className="md:col-span-5 flex flex-col gap-4 md:gap-6">
                                <p className="text-muted-foreground text-xs md:text-base leading-relaxed font-light line-clamp-3 md:line-clamp-none">
                                    {service.desc}
                                </p>
                                <Link
            ...
            <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-background">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        fill
                        className="object-cover opacity-30 md:opacity-40 grayscale-[0.6] contrast-[1.1]"
                        priority
                    />
                        ...
                        {allServicesList.map((service, idx) => {
                            ...
                            return (
                                <Link
                                    key={idx}
                                    href={service.href}
                                    className="group relative p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] bg-overlay border border-border hover:bg-overlay/50 hover:border-primary/30 transition-all duration-500 overflow-hidden flex flex-col gap-6 md:gap-8 h-full"
                                >
                                    <div className="relative z-10 flex justify-between items-start w-full">
                                        ...
                                        <ArrowUpRight className="text-primary opacity-0 md:opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-500" size={24} />
                                    </div>
